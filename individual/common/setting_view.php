										<div class="tab-pane fade active show" id="custom-tabs-four-other" role="tabpanel" aria-labelledby="custom-tabs-four-other-tab">
											<?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="custom-control custom-radio" style="margin-right:20px;">
                                                  <input class="custom-control-input" type="radio" id="customRadio2" value="Condition" name="set" data-toggle="modal" data-target="#modal-default-con" <?php echo $disabled_status; ?>>
