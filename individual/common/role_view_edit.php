<div class="tab-pane fade" id="custom-tabs-edit-role-edit" role="tabpanel" aria-labelledby="custom-tabs-edit-role-tab-edit">
                                        	...
                                        	<div class="row">
												...
												$('#success_a').html("<option value="+dataResult.roleId+" selected>"+dataResult.roleName+"</option>");					
                                                      ...
                                                      <div class="tab-pane fade" id="vert-tabs-nrole" role="tabpanel" aria-labelledby="vert-tabs-nrole-tab">
                                                         ...
                                                         <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label" style="text-align:right;">Add New Role</label>
                                                            <div class="col-sm-6">
                                                              <input type="text" class="form-control" placeholder="Role" id="new_role" name="new_role">
                                                            </div>
                                                          </div>
                                                          <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label" style="text-align:right;">Add New Role Description</label>
                                                            <div class="col-sm-6">
                                                              <textarea class="form-control" rows="3" placeholder="Description" id="role_description" name="role_description"></textarea>
                                                            </div>
                                                          </div>
