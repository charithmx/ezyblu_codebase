        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            	<?php
				$query_pp = "select owner from individual_project where owner = '$username'";
				$result_pp = mysqli_query($con_global, $query_pp);
				
				if(mysqli_num_rows($result_pp)>0){
					$class = ' href="create_project.php" class="nav-link"';	
				}
				else{
					$class = ' href="create_project.php" class="nav-link"';
				}
