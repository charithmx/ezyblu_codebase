      <div class="modal fade" id="modal_edit_type_2">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <form action="build_sub.php" method="post" name="edit_activity">
      ...
      <div class="modal fade" id="modal_delete_type_2">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <form action="build_sub.php" method="post" name="delete_activity">
            <div class="modal-body">
      ...
      <div class="modal fade" id="modal_above_type_2_condition">
