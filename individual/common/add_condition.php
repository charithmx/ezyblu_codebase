<?php
				...
				//		$next_activity_ref = $_POST['next_activity_ref'];
						...
						$query_activity = "INSERT INTO individual_m1_core_activity(core_process_id, sub_process_id, core_process_ref, system_activity_id, activity_ref, activity_ref_next, activity, role, project_id, owner, settings, date) VALUES ('$core_process_id', '', '$core_process_ref', '', '$this_activity_ref', '$next_option_ref', '$this_condition', '$c_role', '$project_id', '$username', '2', '$today')";
						...
						if(!empty($option_variable1)){				
							...
							//	$system_activity_id = $system_activity_id + 1;
								...
								$query_option = "INSERT INTO individual_m1_core_activity(core_process_id, sub_process_id, core_process_ref, system_activity_id, activity_ref, activity_ref_next, activity, role, project_id, owner, settings, date) VALUES ('$core_process_id', '', '$core_process_ref', '', '$this_activity_ref', '${'next_option_activity_ref_variable'.$x}', '${'option_variable'.$x}', '${'con_role_variable'.$x}', '$project_id', '$username', '4', '$today')";
